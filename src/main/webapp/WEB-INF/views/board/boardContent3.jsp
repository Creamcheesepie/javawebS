...
<head>
  ...
  <script>
    ...
    function insertReply(idx, groupId, level, nickName) {
    	...
    	insReply += '</div>';
    	insReply += '</td><td>';
    	insReply += '<input type="button" value="답글달기" onclick="replyCheck('+idx+','+groupId+','+level+')" />';
    ...
    // 대댓글 저장하기
    function replyCheck(idx, groupId, level) {
    	let boardIdx = '${vo.idx}';
    	let mid = '${sMid}';
      ...
      <c:forEach var="replyVO" items="${replyVOS}" varStatus="st">
	        <tr>
	          ...
	          <td class="text-center">
	            ...
	            <input type="button" value="수정" onclick="updateReply('')" id="replyBoxUpdateBtn${replyVO.idx}" class="btn btn-info btn-sm" />
