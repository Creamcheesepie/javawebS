...
<h2>비밀번호 변경</h2>
	...
	<form name="myform" method="post">
		<table class="table table-bordered">
			...
			<tr>
				<th>새 비밀번호 확인</th>
				<td><input type="password" name="rePwd" id="rePwd" class="form-control" autofocus required></td>
			</tr>
			<tr>
				<td colspan="2" class="text-center">
					<input type="button" value="비밀번호 변경" onclick="pwdCheck()" class="btn btn-success">
